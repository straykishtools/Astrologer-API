    ...
    return `
        <div style="max-width:700px;margin:0 auto;">
            ...
            <div style="background:rgba(255,255,255,0.03);border-radius:16px;padding:20px;margin-bottom:20px;border:1px solid rgba(255,255,255,0.05);">
                ...
                <div class="form-group"><label>تاریخ تولد (YYYY-MM-DD)</label><input id="bioBirth" value="1990-01-01"></div>
                <div class="form-group"><label>تاریخ هدف (اختیاری، خالی = امروز)</label><input id="bioTarget" placeholder="YYYY-MM-DD"></div>
                <button onclick="submitBiorhythm()" style="width:100%;padding:12px;background:#6c5ce7;border:none;border-radius:30px;color:#fff;font-weight:bold;cursor:pointer;">🔬 محاسبه بیوریتم</button>
            ...
            <div style="background:rgba(255,255,255,0.03);border-radius:16px;padding:20px;margin-bottom:20px;border:1px solid rgba(255,255,255,0.05);">
                ...
                <div class="form-group"><label>تاریخ تولد</label><input id="bioMonthlyBirth" value="1990-01-01"></div>
                ...
                <button onclick="submitMonthlyOverview()" style="width:100%;padding:12px;background:#00b894;border:none;border-radius:30px;color:#fff;font-weight:bold;cursor:pointer;">📊 نمای ماهانه</button>
...
async function submitBiorhythm() {
    const birth = document.getElementById('bioBirth').value;
...
async function submitMonthlyOverview() {
    const birth = document.getElementById('bioMonthlyBirth').value;
    ...
    return `
        <div style="max-width:700px;margin:0 auto;">
            ...
            <div style="background:rgba(255,255,255,0.03);border-radius:16px;padding:20px;margin-bottom:20px;border:1px solid rgba(255,255,255,0.05);">
                ...
                <button onclick="submitZodiac()" style="width:100%;padding:12px;background:#6c5ce7;border:none;border-radius:30px;color:#fff;font-weight:bold;cursor:pointer;">🐉 محاسبه</button>
            ...
            <div style="background:rgba(255,255,255,0.03);border-radius:16px;padding:20px;margin-bottom:20px;border:1px solid rgba(255,255,255,0.05);">
                ...
                <button onclick="submitZodiacCompat()" style="width:100%;padding:12px;background:#00b894;border:none;border-radius:30px;color:#fff;font-weight:bold;cursor:pointer;">💞 بررسی سازگاری</button>
